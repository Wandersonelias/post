...
class NoticiaControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create noticium" do
    assert_difference('Noticium.count') do
      post noticia_url, params: { noticium: { datepost: @noticium.datepost, description: @noticium.description } }
    end
  ...
  test "should update noticium" do
    patch noticium_url(@noticium), params: { noticium: { datepost: @noticium.datepost, description: @noticium.description } }
